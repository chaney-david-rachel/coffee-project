...
// new coffee list (for style points)
	var coffees = [
		...
		{id: 6, name:'Heywood Hotel Blend', roast:'medium', img:'img/imgHeywood.jpg', flavorText:'This blend was created exclusively for our long-time partners at the Heywood Hotel in East Austin. Their coffee is as unique as their award-winning boutique hotel and provides the same attention to detail they are known for. Many guests ask how to procure the coffee once they leave Austin so the Heywood team has decided to make it available to you!\n' + '\n' +
